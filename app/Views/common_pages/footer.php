					...
					<div class="col-lg-3 col-sm-6">
						...
						<ul class="footer-address-list ftr-details">
							<li>
								...
								<p>Email <span> <a href=""><span class="__cf_email__" data-cfemail="">christianappdevelopers@gmail.com</span></a></span></p>
							</li>
							<li>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="footer-social-media-icons">
								...
								<a href="https://in.linkedin.com/" target="blank"><i class="fab fa-linkedin"></i></a>
							</div>
							<div class="footer-">
								<p>Copyright &copy; <?php echo date("Y");?> Affordable Christian App Developer. All rights reserved</p>
							</div>
						</div>
					</div>
				</div>
